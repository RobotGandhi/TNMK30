...
<html>  
    <head>
        <meta charset="UTF-8"/>
        <title>Homepage | Lego Finder</title>
...
if (isset($_GET['searchkey']) && $_GET['searchkey'] != NULL) {
    ...
    if ($amount_of_results != 0) {
        ...
        echo "<p class='results'>Showing $amount_of_results results</p>";
        echo "<table>\n
        <tr><th>Image </th> <th>PartID</th> <th>Partname</th></tr>\n";
        //Replace spaces with underscores to create valid urls when returning to this page via breadcrumbs.
        ...
        echo "<p class='results'> Sorry, no results were found for \"$searchkey\". Try checking for misspellings.</p>";
    }
} else {
    echo "<h2> Welcome to Lego finder! Here you can search for a lego part and see what sets it's included in.</h2>
    <h2>How to search:</h2>
    <h3>Step 1:</h3>
